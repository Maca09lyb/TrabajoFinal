...
def index(request):
    ...
    product_list = Products.objects.order_by('-id')[3:10]
    ...
    return render(request,'shop/index.html',{'product_cards':product_cards,'product_list':product_list,'product_objects':product_objects,
        "lista_secciones": Seccion.objects.all(),
        "lista_articulos": Products.objects.all(),})
...
def acercade(request):
    return render(request,"shop/acercade.html")